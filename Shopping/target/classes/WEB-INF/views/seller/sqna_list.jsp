  ...
  <div id="root">
    ...
    <section id="container">
      ...
      <div id="container_box" class="container">
        ...
        <form action="sqna_list" method="get" enctype="multipart/form-data">
          <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            <thead>
              ...
              <tr>
                <th colspan="4">
                  <a href="sqna_register"><input type="button" value="글작성"></a>
                </th>
              </tr>
              <tr>
                <th>번호</th>
            ...
            <tbody>
      <c:forEach var="vo" items="${mysqnaList }">
        <tr>
          <td>${vo.sqID }</td>
          <td><a href="sqna_detail?sqID=${vo.sqID }&page=${pageMaker.criteria.page}">${vo.sqTITLE }</a></td>
          <td>${vo.sqWRITER}</td>
        ...
        <div>
          <form id="pagingForm" style="display: none;">
            ...
            <input type="text" name="sID" value="${sqWRITER }">
          </form>
        </div>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        $('.pager li a').click(function() {
          ...
          frm.attr('action', 'sqna_list'); // form에 action 속성-값 추가
