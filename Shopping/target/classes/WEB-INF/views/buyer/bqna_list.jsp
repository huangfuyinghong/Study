        ...
        <form action="bqna_list" method="get"  enctype="multipart/form-data">
          <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            <thead>
              ...
              <tr>
                <th colspan="4">
                  <a href="bqna_register"><input type="button" value="글작성"></a>
                </th>
              </tr>
              <tr>
                <th>번호</th>
            ...
            <tbody>
      <c:forEach var="vo" items="${mybqnaList }">
        <tr>
          <td>${vo.bqID }</td>
          <td><a href="bqna_detail?bqID=${vo.bqID }&page=${pageMaker.criteria.page}">${vo.bqTITLE }</a></td>
          <td>${vo.bqWRITER }</td>
