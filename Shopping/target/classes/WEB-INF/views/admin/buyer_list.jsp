  ...
  <header id="header">
    ...
    <aside>
      ...
      <div id="container_box" class="container">
        <form action="buyer_list" method="get" enctype="multipart/form-data">
            ...
            <tbody>
              <c:forEach var="vo" items="${buyerList }">
                <tr>
                  <td>${vo.bNO }</td>
                  <td>
                    <a href="buyer_detail?bID=${vo.bID }&page=${pageMaker.criteria.page}">${vo.bID }</a>
                  </td>
                  <td>${vo.bPHONE }</td>
                  <td>${vo.bEMAIL }</td>
                  <td>${vo.bPOST }</td>
                  <td>${vo.bADDRESS}</td>
                  <fmt:formatDate value="${vo.bCDATE }" pattern="yyyy-MM-dd HH:mm:ss" var="bCDATE" />
                  <td>${bCDATE }</td>
                  <td>${vo.bLEVEL}</td>
                  <td>${vo.bDROP}</td>
                </tr>
