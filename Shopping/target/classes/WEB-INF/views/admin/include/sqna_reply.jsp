    ...
    <c:if test="${admin != null }">
      <tr>
        <td style="width: 120px;">
          <h5>답변</h5>
          <input type="hidden" id="qnaID" value=${sqnaVO.sqID }>
          <input type="hidden" id="replyWRITER" value=${admin.aID } placeholder="아이디 입력">
        </td>
        <td>
          <textarea rows="2" cols="60" id="replyCONTENT" placeholder="내용 입력" required="required"></textarea>
        </td>
        <td>
