  ...
  <div id="root">
    ...
    <section id="container">
      ...
      <div id="container_box" class="container">
        ...
        <form action="buyer_qna_list" method="get" enctype="multipart/form-data">
          <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            ...
            <tbody>
      <c:forEach var="vo" items="${bqnaList }">
        <tr>
          <td>${vo.bqID }</td>
          <td><a href="buyer_qna_detail?bqID=${vo.bqID }&page=${pageMaker.criteria.page}">${vo.bqTITLE }</a></td>
          <td>${vo.bqWRITER }</td>
          <fmt:formatDate value="${vo.bqCDATE }"
