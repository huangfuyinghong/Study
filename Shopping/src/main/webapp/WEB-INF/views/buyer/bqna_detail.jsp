  ...
  <div id="root">
    ...
    <section id="container">
      ...
      <div id="container_box" class="container">
        <form action="bqna_detail" method="post" enctype="multipart/form-data">
              ...
              <tr>
                <th colspan="2">
                  ...
                  <div style="float:right;">
                    <a href="bqna_list?bID=${buyer.bID }">
                      <input type="button" value="글 목록">
                    </a>
                    <a href="bqna_update?bqID=${bqnaVO.bqID }&page=${page}">
                      <input type="button" value="글 수정">
                    </a>
                    <a href="bqna_delete?bqID=${bqnaVO.bqID }&page=${page}">
